...
export default function Asus(){
    ...
    useEffect(() => {
    const fetchProducts = fetch("https://api.digileas.com/general/products?category=%D8%A7%DB%8C%D8%B3%D9%88%D8%B3")
        .then((res) => res.json());
    ...
    // useEffect(() => {
    //     fetch("https://api.digileas.com/general/products?category=%D8%A7%DB%8C%D8%B3%D9%88%D8%B3")
    //     .then((res) => res.json())
    //     .then((data) => {
